                        ...
                        switch (update.Type)
                        {
                            case UpdateType.Message:
                                ...
                                if (message != null)
                                {
                                    ...
                                    await new HandeUpdateMessage().HandeUpdateMessageAsync(botClient, message, receiverService, courseService, studentService, noteService, scenarioService, imageService, cancellationToken);
                                }
                                return;
